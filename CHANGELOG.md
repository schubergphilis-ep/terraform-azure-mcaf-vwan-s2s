...
* feat: support multiple mappings per NAT rule (#10) @Blankf

**Full Changelog**: https://github.com/schubergphilis/terraform-azure-mcaf-vwan-s2s/compare/v0.3.0...v0.4.0
